  ...
  return (
    <div className="min-h-screen bg-[#0A0A0C] text-white grid-bg"><Sidebar/><main className="lg:pl-64 pb-20 lg:pb-10 p-6 md:p-10">
      <div className="mx-auto max-w-5xl">
        ...
        <h1 className="mt-3 text-4xl font-display font-black tracking-wide tracking-tight">{t('commerceTitle')}</h1>
        <p className="mt-3 max-w-2xl text-lg opacity-70">{t('commerceSubtitle')}</p>
        <DynastyAIContextPanel area="Commerce Intelligence" />
        <DynastyAIChat mode="commerce" placeholder={t('commercePlaceholder')} />
      </div>
    </main></div>
  )
}
