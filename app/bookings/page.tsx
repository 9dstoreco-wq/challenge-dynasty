...
export default async function BookingsPage(){
 ...
 return <main className="min-h-screen bg-[#0A0A0C] text-white grid-bg"><Sidebar/><section className="lg:pl-64 p-6 lg:p-12 max-w-[1400px] mx-auto"><div className="mb-8"><div className="text-[#D4AF37] text-xs font-black tracking-[.28em] uppercase">Dynasty Booking OS</div><h1 className="text-4xl md:text-6xl font-display font-black tracking-wide tracking-tight mt-2">Reservas avanzadas</h1><p className="text-white/50 mt-3 max-w-3xl">Reserva recursos, servicios y actividades con validación atómica, capacidad y control de conflictos.</p></div><BookingControlCenter bookables={bookables ?? []} bookings={bookings ?? []}/></section></main>
}
