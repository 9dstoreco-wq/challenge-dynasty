...
export default async function SettingsPage() {
  ...
  const [{ data: profile }, { data: clubs }, { data: sports }, { data: profileSports }] = await Promise.all([
