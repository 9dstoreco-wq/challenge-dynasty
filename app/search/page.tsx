...
export default async function SearchPage({searchParams}:{searchParams?:Promise<{q?:string}>}){
  ...
  const q=(resolvedSearchParams?.q??'').trim(); const safeQ=q.replace(/[(),]/g,' '); const supabase=createClient()
