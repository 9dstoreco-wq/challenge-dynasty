...
export default async function TrickDetail({params}:{params:{id:string}}){
  const supabase=createClient()
  const {data:challenge}=await supabase.from('skill_challenges').select('id,title,description,category,difficulty,points,target_votes,status,expires_at,created_at,creator_id').eq('id',params.id).maybeSingle()
