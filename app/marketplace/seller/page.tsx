    ...
    <main className="min-h-screen bg-[#0A0A0C] text-white grid-bg">
      ...
      <section className="lg:pl-64 p-6 lg:p-12 max-w-[1250px] mx-auto">
        <div className="flex flex-wrap items-end justify-between gap-5 mb-8">
          <div><PageHero><div className="text-[#D4AF37] text-xs font-black tracking-[.28em] uppercase">Marketplace · Seller OS</div><h1 className="text-4xl md:text-5xl font-display font-black tracking-wide mt-2">Centro del vendedor</h1><p className="text-white/45 mt-2">Pedidos que involucran tus publicaciones y estado comercial.</p></PageHero></div>
